# 1 "joystick/IRQ_Joystick.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 394 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "joystick/IRQ_Joystick.c" 2
...
# 2 "joystick/IRQ_Joystick.c" 2
# 1 "joystick\\../common.h" 1
...
# 83 "joystick\\../common.h"
typedef enum {
 STATE_IDLE,
 STATE_RESET
} state_t;
# 3 "joystick/IRQ_Joystick.c" 2
# 1 "joystick\\../led/led.h" 1
# 10 "joystick\\../led/led.h"
...
# 11 "joystick\\../led/led.h" 2
# 22 "joystick\\../led/led.h"
void LED_init(void);
...
# 72 "joystick\\../led/led.h"
void LED_Out_Range(unsigned int value, uint8_t from_led_num, uint8_t to_led_num);
# 4 "joystick/IRQ_Joystick.c" 2
# 1 "joystick\\joystick.h" 1



# 1 "joystick\\../led/led.h" 1
# 5 "joystick\\joystick.h" 2
# 32 "joystick\\joystick.h"
typedef enum {
  JOY_UP = 0,
  JOY_DOWN,
  JOY_LEFT,
...
extern joystick_callback_t joystick_short_handlers[JOY_DIR_COUNT];
extern joystick_callback_t joystick_long_handlers[JOY_DIR_COUNT];
...
# 5 "joystick/IRQ_Joystick.c" 2
# 19 "joystick/IRQ_Joystick.c"
...
extern uint32_t VETT1[];
extern uint32_t vett1_idx;
extern uint8_t VETT2[];
...
static void joy_up_long(void) {



}

static void joy_down_long(void) {



}

static void joy_left_long(void) {

  LED_ToggleAll();

}

static void joy_right_long(void) {



}

static void joy_select_long(void) {
...
static void joy_up_left_long(void) {



}

static void joy_up_right_long(void) {



}

static void joy_bottom_left_long(void) {



}

static void joy_bottom_right_long(void) {
...
joystick_callback_t joystick_short_handlers[JOY_DIR_COUNT] = {
    ...
    joy_up_left_short,
    joy_up_right_short,
    joy_bottom_left_short,
    joy_bottom_right_short
};

joystick_callback_t joystick_long_handlers[JOY_DIR_COUNT] = {
    joy_up_long,
    joy_down_long,
    joy_left_long,
    joy_right_long,
    ...
    joy_up_left_long,
    joy_up_right_long,
    joy_bottom_left_long,
    joy_bottom_right_long
};
