# 1 "button_EXINT/lib_button.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 394 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "button_EXINT/lib_button.c" 2
# 1 "button_EXINT\\button.h" 1



# 1 "button_EXINT\\../led/led.h" 1
# 10 "button_EXINT\\../led/led.h"
...
# 12 "button_EXINT\\../led/led.h" 2
# 22 "button_EXINT\\../led/led.h"
void LED_init(void);
...
# 6 "button_EXINT\\button.h" 2
# 28 "button_EXINT\\button.h"
typedef enum { BTN_0 = 0, BTN_1, BTN_2, BTN_COUNT } button_num_t;

typedef void (*button_callback_t)(void);


extern button_callback_t button_short_handlers[BTN_COUNT];
extern button_callback_t button_long_handlers[BTN_COUNT];
...
int button_check_pressed(uint32_t pin_mask) {
  if ((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & pin_mask) == 0U)
    return 1;
  return 0;
}
...
void BUTTON_disable_0(void) { _button_set_enabled(0, 0); }
void BUTTON_disable_1(void) { _button_set_enabled(1, 0); }
void BUTTON_disable_2(void) { _button_set_enabled(2, 0); }

void BUTTON_enable_0(void) { _button_set_enabled(0, 1); }
void BUTTON_enable_1(void) { _button_set_enabled(1, 1); }
void BUTTON_enable_2(void) { _button_set_enabled(2, 1); }
