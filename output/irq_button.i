# 1 "button_EXINT/IRQ_button.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 394 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "button_EXINT/IRQ_button.c" 2
...
# 3 "button_EXINT/IRQ_button.c" 2
# 1 "button_EXINT\\../common.h" 1
...
# 83 "button_EXINT\\../common.h"
typedef enum {
 STATE_IDLE,
 STATE_RESET
} state_t;
# 4 "button_EXINT/IRQ_button.c" 2
# 17 "button_EXINT/IRQ_button.c"
...
static void btn1_long(void) {

 LED_ToggleAll();

}

static void btn2_long(void) {
...
button_callback_t button_long_handlers[BTN_COUNT] = {
    btn0_long,
    btn1_long,
    btn2_long
};
...
void EINT0_IRQHandler(void) { ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT |= (1 << 0); }

void EINT1_IRQHandler(void) { ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT |= (1 << 1); }

void EINT2_IRQHandler(void) { ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT |= (1 << 2); }
