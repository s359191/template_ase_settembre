...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "timer/IRQ_timer.c" 2
# 1 "timer\\timer.h" 1
# 1 "timer\\../joystick/joystick.h" 1



# 1 "timer\\../joystick\\../led/led.h" 1
# 10 "timer\\../joystick\\../led/led.h"
...
# 12 "timer\\../joystick\\../led/led.h" 2
# 22 "timer\\../joystick\\../led/led.h"
void LED_init(void);
...
# 6 "timer\\../joystick/joystick.h" 2
# 32 "timer\\../joystick/joystick.h"
typedef enum {
  JOY_UP = 0,
  JOY_DOWN,
  JOY_LEFT,
...
typedef enum {
  ...
  TMR_ERR_TIMER_NUM,
  TMR_ERR_PERIOD_ZERO,
  TMR_ERR_FINITE_ON_SINGLE,
  TMR_ERR_FINITE_NO_DURATION,
  TMR_ERR_PWM_ON_RANGE,
  TMR_ERR_PWM_SINGLE
} tmr_status_t;
